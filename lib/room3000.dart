...
import 'package:miniprojectsj/main.dart';
...
List<String>urls=[
    ...
    "https://cdn.discordapp.com/attachments/884449013208846360/1076882530109759690/241857775_931436740801189_3976500474899887325_n.jpg",  
  ];
class room3000 extends StatefulWidget {
  const room3000({super.key});

  @override
  State<room3000> createState() => _MyWidgetState();
}

class _MyWidgetState extends State<room3000> {
  @override
